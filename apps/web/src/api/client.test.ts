  ...
  vi.stubGlobal(
    ...
    vi.fn(async () => ({
      ...
      headers: {
        get: (name: string) =>
          name === "X-Bead-Timing"
            ? "total_ms=5300.5; read_ms=0.2; decode_ms=12.3; ocr_init_ms=700.0; recognize_ms=4580.0; ocr_ms=3900.0; ocr_reps=9; ocr_engine_calls=9; ocr_engine_max_ms=620.0; save_ms=8.0"
            : null,
      },
      json: async () => project,
    })),
